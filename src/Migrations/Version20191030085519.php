 ...
 */
class Version20191030085519 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, agent_id INT DEFAULT NULL, client_id INT DEFAULT NULL, content VARCHAR(3000) NOT NULL, create_at DATETIME NOT NULL, INDEX IDX_9474526C3414710B (agent_id), INDEX IDX_9474526C19EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, admin_comment_id INT DEFAULT NULL, private_comment_id INT DEFAULT NULL, public_comment_id INT DEFAULT NULL, agent_id INT DEFAULT NULL, client_id INT DEFAULT NULL, currency_id INT DEFAULT NULL, tax_id INT DEFAULT NULL, status_id INT DEFAULT NULL, delivery_id INT DEFAULT NULL, created_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_F52993983057DB96 (admin_comment_id), UNIQUE INDEX UNIQ_F5299398F5ACD764 (private_comment_id), UNIQUE INDEX UNIQ_F529939862FBE97E (public_comment_id), INDEX IDX_F52993983414710B (agent_id), INDEX IDX_F529939819EB6921 (client_id), INDEX IDX_F529939838248176 (currency_id), INDEX IDX_F5299398B2A824D8 (tax_id), INDEX IDX_F52993986BF700BD (status_id), INDEX IDX_F529939812136921 (delivery_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE bill ADD CONSTRAINT FK_7A2119E3251A8A50 FOREIGN KEY (order__id) REFERENCES `order` (id)');
        ...
        $this->addSql('ALTER TABLE `order` ADD CONSTRAINT FK_F52993983057DB96 FOREIGN KEY (admin_comment_id) REFERENCES comment (id)');
        $this->addSql('ALTER TABLE `order` ADD CONSTRAINT FK_F5299398F5ACD764 FOREIGN KEY (private_comment_id) REFERENCES comment (id)');
        $this->addSql('ALTER TABLE `order` ADD CONSTRAINT FK_F529939862FBE97E FOREIGN KEY (public_comment_id) REFERENCES comment (id)');
        $this->addSql('ALTER TABLE `order` ADD CONSTRAINT FK_F52993983414710B FOREIGN KEY (agent_id) REFERENCES agent (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP FOREIGN KEY FK_F52993983414710B');
        ...
        $this->addSql('ALTER TABLE `order` DROP FOREIGN KEY FK_F52993983057DB96');
        $this->addSql('ALTER TABLE `order` DROP FOREIGN KEY FK_F5299398F5ACD764');
        $this->addSql('ALTER TABLE `order` DROP FOREIGN KEY FK_F529939862FBE97E');
