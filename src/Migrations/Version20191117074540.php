 ...
 */
final class Version20191117074540 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE agent (id INT AUTO_INCREMENT NOT NULL, comment_id INT DEFAULT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, phone VARCHAR(255) DEFAULT NULL, fax VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, user_name VARCHAR(255) NOT NULL, password VARCHAR(300) NOT NULL, picture VARCHAR(255) DEFAULT NULL, is_admin TINYINT(1) NOT NULL, is_online TINYINT(1) DEFAULT NULL, list_size INT DEFAULT NULL, is_activated TINYINT(1) NOT NULL, ipaddress VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_268B9C9DF8697D13 (comment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE setting (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, value VARCHAR(3000) DEFAULT NULL, code VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE delivery (id INT AUTO_INCREMENT NOT NULL, status_id INT DEFAULT NULL, bill_id INT DEFAULT NULL, package INT NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_3781EC106BF700BD (status_id), UNIQUE INDEX UNIQ_3781EC101A8C12F5 (bill_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE quote_order_detail (id INT AUTO_INCREMENT NOT NULL, quote_order_id INT DEFAULT NULL, item_id INT DEFAULT NULL, tax_id INT DEFAULT NULL, quantity INT NOT NULL, quantity_delivery INT DEFAULT NULL, quantity_recieved INT DEFAULT NULL, INDEX IDX_5A68304067A5C5A9 (quote_order_id), INDEX IDX_5A683040126F525E (item_id), INDEX IDX_5A683040B2A824D8 (tax_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE quote_order_detail_delivery DROP FOREIGN KEY FK_5752D01912136921');
        ...
        $this->addSql('ALTER TABLE quote_order_detail_delivery DROP FOREIGN KEY FK_5752D0198AF49733');
